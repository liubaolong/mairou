<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\wamp\www\mairou\dingcan\public/../application/sadmin\view\sindex\rece.html";i:1503283798;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="content" class="input" style="height:300px; resize:none;border:1px solid #ddd;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
