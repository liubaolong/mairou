<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\wamp\www\mairou\dingcan\public/../application/index\view\index\category.html";i:1503283797;s:78:"D:\wamp\www\mairou\dingcan\public/../application/index\view\public\layout.html";i:1503324306;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<section class="Psection">
 ...
 <section class="CateL Overflow">
  <ul>
   ...
   <li> 
   <a href="<?php echo url('meal/detailsp'); ?>" target="_blank" title="酸辣土豆丝">
   <img src="__UPLOAD_PATH__/03.jpg">
   <p class="Overflow">酸辣土豆丝</p>
   <p class="Overflow">赠送：<span class="CorRed Font16">2</span>积分<i></i></p>
   <p class="Overflow">好味来快餐连锁店</p>
   <p class="Overflow">地址：莲湖区土门十字往西100米</p>
 ...
 <!--广告位或推荐位-->
  <div>
   <a href="#" target="_blank"><img src="__UPLOAD_PATH__/ad.jpg"></a>
  </div>
  <div class="Hot_shop">
   <span class="Hshoptile Font14 FontW Block">热门商家</span>
   <ul>
    <li>
     <a href="<?php echo url('shop/shop'); ?>" target="_blank" title="好味来快餐连锁店"><img src="__UPLOAD_PATH__/cc.jpg"></a>
    ...
    <li>
     <a href="<?php echo url('shop/shop'); ?>" target="_blank" title="好味来快餐连锁店"><img src="__UPLOAD_PATH__/dd.jpg"></a>
     <p class="Font14 FontW Overflow Lineheight35"><a href="shop.html" target="_blank" title="好味来快餐连锁店">好味来快餐连锁店</a></p>
     <p class="Lineheight35 Overflow"><span title="通过动态控制地址的字符数量...">地址：西安市莲湖区土门新市场斜对面...</span></p>
    </li>
    <li>
     <a href="<?php echo url('shop/shop'); ?>" target="_blank" title="好味来快餐连锁店"><img src="__UPLOAD_PATH__/ee.jpg"></a>
     <p class="Font14 FontW Overflow Lineheight35"><a href="shop.html" target="_blank" title="好味来快餐连锁店">好味来快餐连锁店</a></p>
     <p class="Lineheight35 Overflow"><span title="通过动态控制地址的字符数量...">地址：西安市莲湖区土门新市场斜对面...</span></p>
    </li>
    <li>
