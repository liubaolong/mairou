<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\Wamp\wamp\www\mairou\dingcan\public/../application/index\view\auth\lookfor.html";i:1503399633;s:83:"D:\Wamp\wamp\www\mairou\dingcan\public/../application/index\view\public\layout.html";i:1503390646;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<h2 style="padding-left:250px;">找回密码：</h2>
 <form action="<?php echo url('auth/gaipwd'); ?>" method="post" id="form1">
  ...
  $("input[name='phone']").blur(function(){
    if ($(this).val() == '') {
      ...
      flag['phone'] = false;
        ...
        $.post("<?php echo url('auth/isphone'); ?>", {phone:$('.phone').val(),uname:$('#usname').val()}, function(data){
            if (data.errorcode) {
              flag['phone'] = true;
              $().css();
            } else {
